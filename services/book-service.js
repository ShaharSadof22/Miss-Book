...
function getGoogleBooks() {
  get.axios('https://www.googleapis.com/books/v1/volumes?printType=books&q=effective%20javascript')
    .then(res => console.log("getGoogleBooks -> res.data", res.data))
...
function addGoogleBook(googleBook) {
  storageService.getBooksFromStore()
    ...
    .catch(() => {
      console.log("get Books From Store Failed...");
    })
}

function makeGoogleBookToRegular(googleBook) {
  let newBook = {
    id: googleBook.id,
