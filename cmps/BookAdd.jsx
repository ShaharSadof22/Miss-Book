...
import { DropdownSearch } from '../cmps/DropdownSearch.jsx'
...
export class BookAdd extends React.Component {
    ...
    googleBooks = {
        ...
        canonicalVolumeLink: "https://play.google.com/store/books/details?id=nBuA0hmspdMC"
        },
        saleInfo: {
        country: "IL",
        ...
        language: "ja",
        previewLink: "http://books.google.com/books?id=lT2g_y4VYx0C&pg=PT7&dq=effective+javascript&hl=&as_pt=BOOKS&cd=2&source=gbs_api",
        infoLink: "https://play.google.com/store/books/details?id=lT2g_y4VYx0C&source=gbs_api",
        canonicalVolumeLink: "https://play.google.com/store/books/details?id=lT2g_y4VYx0C"
        },
        saleInfo: {
        country: "IL",
        saleability: "FOR_SALE",
        ...
        searchInfo: {
        textSnippet: "後者は、<b>JavaScript</b>のように柔軟で表現力の高い言語では、とくに洞察力が求め<br> られる課題であろう。これは<b>JavaScript</b>の実践に関する本だ。入門書ではない。<br> 読者には、プログラミング一般、とくに<b>JavaScript</b>について、ある程度は馴染み<br> の&nbsp;..."
        }
        },
        {
        kind: "books#volume",
        ...
        language: "zh-CN",
        previewLink: "http://books.google.com/books?id=gg20DgAAQBAJ&pg=PR3&dq=effective+javascript&hl=&as_pt=BOOKS&cd=3&source=gbs_api",
        infoLink: "https://play.google.com/store/books/details?id=gg20DgAAQBAJ&source=gbs_api",
        canonicalVolumeLink: "https://play.google.com/store/books/details?id=gg20DgAAQBAJ"
        },
        saleInfo: {
        country: "IL",
        saleability: "FOR_SALE",
        ...
        searchInfo: {
        textSnippet: "<b>Effective JavaScript</b> 的各界好評「完全符合 <b>Effective</b> Software Development 系列<br> 程式設計書籍的高標準,對從事專業 <b>JavaScript</b> 程式設計工作的任何人來說,Dave <br> Herman 的 <b>Effective JavaScript</b> 都是必備的讀物。此書對於 <b>JavaScript</b> 內部運作<br> 原理&nbsp;..."
        }
        },
        {
        kind: "books#volume",
        ...
        language: "ja",
        previewLink: "http://books.google.com/books?id=yg0fBAAAQBAJ&pg=PA91&dq=effective+javascript&hl=&as_pt=BOOKS&cd=4&source=gbs_api",
        ...
        searchInfo: {
        textSnippet: "項目34 メソッドをプロトタイプに格納しよう <b>JavaScript</b>でも、プロトタイプなし<br> でプログラミングすることは完全に可能である。項目30 のUserクラスは、その<br> プロトタイプで何も特別な定義をしなくても、次のように実装できそうだ。"
        }
        },
        {
        kind: "books#volume",
        ...
        language: "en",
        previewLink: "http://books.google.com/books?id=--gvDwAAQBAJ&printsec=frontcover&dq=effective+javascript&hl=&as_pt=BOOKS&cd=5&source=gbs_api",
        infoLink: "https://play.google.com/store/books/details?id=--gvDwAAQBAJ&source=gbs_api",
        canonicalVolumeLink: "https://play.google.com/store/books/details?id=--gvDwAAQBAJ"
        },
        saleInfo: {
        country: "IL",
        saleability: "FOR_SALE",
        ...
        language: "en",
        previewLink: "http://books.google.com/books?id=lLnefnWKhvIC&q=effective+javascript&dq=effective+javascript&hl=&as_pt=BOOKS&cd=6&source=gbs_api",
        ...
        searchInfo: {
        textSnippet: "10 Part I Even considering VBScript, JavaScript has emerged as the standard <br> Web scripting language. ... If you have little background in HTML, you will <br> discover that, to be an <b>effective JavaScript</b> developer, you also need to learn the <br> ins and&nbsp;..."
        }
        },
        {
        kind: "books#volume",
        ...
        language: "en",
        previewLink: "http://books.google.com/books?id=25AEAwAAQBAJ&printsec=frontcover&dq=effective+javascript&hl=&as_pt=BOOKS&cd=7&source=gbs_api",
        ...
        searchInfo: {
        textSnippet: "But there is one more subtlety in the <b>JavaScript</b> code. Each time the <b>JavaScript</b> <br> code opens a window for the image, the name of the image is appended with a <br> timestamp (systime). Why this constant change of name for the image? Initially, <br> we&nbsp;..."
        }
        },
        {
        kind: "books#volume",
        ...
        searchInfo: {
        textSnippet: "To accommodate this, Windows automatically scales down the <b>effective</b> <br> resolution that&#39;s reported to apps, which is to say that whatever coordinates you <br> use within your app (in HTML, CSS, and <b>JavaScript</b>) are automatically scaled up <br> to the&nbsp;..."
        }
        },
        {
        kind: "books#volume",
        ...
        searchInfo: {
        textSnippet: "Along this line , most of the JavaScript objects have HTML tags that they <br> represent . If you have little background in HTML , you will discover that to be an <br> <b>effective JavaScript</b> developer , you also need to learn the ins and outs of HTML ."
        }
        }
        ]
        }
    ...
    render() {
        return <div>
            ...
            <input list="book-list" name="input-add-book" 
            placeholder="Search for a book" onChange={this.onBookSearch}/>
            {this.state.searchInput && <DropdownSearch search={this.state.searchInput} googleBooks={this.googleBooks.items}/>}
